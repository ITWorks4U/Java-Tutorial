...
public class Example {
	...
	public static void main(String[] args) {
		...
		//	-----------------------
//		BasicSingleton bs01 = BasicSingleton.getInstance();
//		BasicSingleton bs02 = BasicSingleton.getInstance();
//		
//		System.out.println(bs01);
//		System.out.println(bs02);
		
		//	-----------------------
		BasicSingletonEnum.INSTANCE.addObjectToList(go);
		BasicSingletonEnum.INSTANCE.addObjectToList(cube);
		BasicSingletonEnum.INSTANCE.addObjectToList(pyramid);
		
		List<GeometricObject> listOfObjects = BasicSingletonEnum.INSTANCE.getListOfObjects();
